...
var thFirstWidth = document.querySelector('.display.dataTable th:first-child').getBoundingClientRect();
thFirstWidth = Math.ceil(thFirstWidth.width);
var thSecondWidth = document.querySelector('.display.dataTable th:nth-child(2)').getBoundingClientRect();
thSecondWidth = Math.ceil(thSecondWidth.width);
...
console.log(thFirstWidth);
console.log(thSecondWidth);
...
function nameUpdate(id, name) {
    ...
    document.getElementById('sellerInfoTitle').innerText = title;
    document.getElementById('sellerInfoContent').innerText = content;
    document.getElementById('sellerInfoUser').innerText = user;
    document.getElementById('sellerInfoInput1').value = "1";
    document.getElementById('sellerInfoInput2').value = id;
}
...
function birthUpdate(id, name) {
    ...
    document.getElementById('sellerInfoContent').innerText = content;
    document.getElementById('sellerInfoUser').innerText = user;
    document.getElementById('sellerInfoInput1').value = "2";
    document.getElementById('sellerInfoInput2').value = id;
}
function emailUpdate(id, name) {
    ...
    document.getElementById('sellerInfoContent').innerText = content;
    document.getElementById('sellerInfoUser').innerText = user;
    document.getElementById('sellerInfoInput1').value = "3";
    document.getElementById('sellerInfoInput2').value = id;
}
function addressUpdate(id, name) {
    ...
    document.getElementById('sellerInfoContent').innerText = content;
    document.getElementById('sellerInfoUser').innerText = user;
    document.getElementById('sellerInfoInput1').value = "4";
    document.getElementById('sellerInfoInput2').value = id;
}
function phoneNumUpdate(id, name) {
    ...
    document.getElementById('sellerInfoContent').innerText = content;
    document.getElementById('sellerInfoUser').innerText = user;
    document.getElementById('sellerInfoInput1').value = "5";
    document.getElementById('sellerInfoInput2').value = id;
}
function bNumUpdate(id, name) {
    var title = "사업자 번호 변경";
    var content = "사용자의 사업자 번호가 변경됩니다";
    var user = name + "님의 변경될 사업자 번호";

    hideAll();
    hideInput[9].classList.remove('hide');

    document.getElementById('sellerInfoTitle').innerText = title;
    document.getElementById('sellerInfoContent').innerText = content;
    document.getElementById('sellerInfoUser').innerText = user;
    document.getElementById('sellerInfoInput1').value = "6";
    document.getElementById('sellerInfoInput2').value = id;
}

function sellerInfoUpdate() {

    if (document.getElementById('sellerInfoInput1').value === "1" &&
                     document.getElementById('infoInput1').value.trim() === "") {
        alert('이름을 입력해주세요');
        return;
     } else if (document.getElementById('sellerInfoInput1').value === "2" &&
                 document.getElementById('infoInput2').value.trim() === "") {
        alert("생년월일을 입력해주세요");
        return;
    } else if (document.getElementById('sellerInfoInput1').value === "3" &&
                 document.getElementById('infoInput3').value.trim() === "") {
        alert("이메일을 입력해주세요");
        return;
    } else if (document.getElementById('sellerInfoInput1').value === "4" &&
    ...
    } else if (document.getElementById('sellerInfoInput1').value === "5" &&
                 document.getElementById('infoInput4').value.trim() === "") {
        alert("전화번호를 입력해주세요");
        return;
    } else if (document.getElementById('sellerInfoInput1').value === "6" &&
                 document.getElementById('infoInput5').value.trim() === "") {
        alert("사업자번호를 입력해주세요");
        return;
    }
    ...
    if (confirm("변경하시겠습니까?")) {
        ...
        document.infoFrm.action = "/admin/seller/sellerInfoUpdate";
